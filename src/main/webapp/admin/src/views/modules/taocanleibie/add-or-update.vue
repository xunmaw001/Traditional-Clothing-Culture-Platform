<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="套餐类别" prop="taocanleibie">
					<el-input v-model="ruleForm.taocanleibie" placeholder="套餐类别" clearable  :readonly="ro.taocanleibie"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else class="input" label="套餐类别" prop="taocanleibie">
					<el-input v-model="ruleForm.taocanleibie" placeholder="套餐类别" readonly></el-input>
				</el-form-item>
			</template>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `taocanleibie/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.taocanleibieCrossAddOrUpdateFlag = false;
						 this.parent.search();
