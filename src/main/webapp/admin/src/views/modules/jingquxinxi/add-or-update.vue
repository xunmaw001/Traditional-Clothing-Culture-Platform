<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="景点编号" prop="jingdianbianhao">
					<el-input v-model="ruleForm.jingdianbianhao" placeholder="景点编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jingdianbianhao" label="景点编号" prop="jingdianbianhao">
					<el-input v-model="ruleForm.jingdianbianhao" placeholder="景点编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="景点标题" prop="jingdianbiaoti">
					<el-input v-model="ruleForm.jingdianbiaoti" placeholder="景点标题" clearable  :readonly="ro.jingdianbiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else class="input" label="景点标题" prop="jingdianbiaoti">
					<el-input v-model="ruleForm.jingdianbiaoti" placeholder="景点标题" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.jingdianzhaopian" label="景点照片" prop="jingdianzhaopian">
					<file-upload
						tip="点击上传景点照片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.jingdianzhaopian" label="景点照片" prop="jingdianzhaopian">
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="景点位置" prop="jingdianweizhi">
					<el-input v-model="ruleForm.jingdianweizhi" placeholder="景点位置" clearable  :readonly="ro.jingdianweizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else class="input" label="景点位置" prop="jingdianweizhi">
					<el-input v-model="ruleForm.jingdianweizhi" placeholder="景点位置" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="景点简介" prop="jingdianjianjie">
					<el-input
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else-if="ruleForm.jingdianjianjie" label="景点简介" prop="jingdianjianjie">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.jingdianjianjie}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="景点详情" prop="jingdianxiangqing">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else-if="ruleForm.jingdianxiangqing" label="景点详情" prop="jingdianxiangqing">
