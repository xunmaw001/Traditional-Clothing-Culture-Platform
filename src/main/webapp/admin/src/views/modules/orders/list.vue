		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"width":"10%","padding":"0 10px","margin":"0 0 20px"}' :inline="true" :model="searchForm">
				...
				<el-row :style='{"margin":"20px 0","flexDirection":"column","display":"flex"}'>
					...
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0","boxShadow":"3px 3px 2px 0px #D0CCBA","margin":"0 0 6px","borderColor":"#D5EBC4","color":"#000","outline":"none","borderRadius":"0","background":"#fff","borderWidth":"4px 0 0","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>


					<download-excel v-if="isAuth('orders'+'/'+orderStatus,'导出')" class="export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "订单.xls">
						<!-- 导出excel -->
						<el-button :style='{"border":"0","cursor":"pointer","padding":"0","boxShadow":"3px 3px 2px 0px #D0CCBA","margin":"0 0 6px","borderColor":"#D5EBC4","color":"#000","outline":"none","borderRadius":"0","background":"#fff","borderWidth":"4px 0 0","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="danger">导出</el-button>
					</download-excel>


					<el-button :style='{"border":"0","cursor":"pointer","padding":"0","boxShadow":"3px 3px 2px 0px #D0CCBA","margin":"0 0 6px","borderColor":"#D5EBC4","color":"#000","outline":"none","borderRadius":"0","background":"#fff","borderWidth":"4px 0 0","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'日销量')" type="warning" @click="dayNumberChartDialog()">日销量</el-button>

					<el-button :style='{"border":"0","cursor":"pointer","padding":"0","boxShadow":"3px 3px 2px 0px #D0CCBA","margin":"0 0 6px","borderColor":"#D5EBC4","color":"#000","outline":"none","borderRadius":"0","background":"#fff","borderWidth":"4px 0 0","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'月销量')" type="warning" @click="monthNumberChartDialog()">月销量</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0","boxShadow":"3px 3px 2px 0px #D0CCBA","margin":"0 0 6px","borderColor":"#D5EBC4","color":"#000","outline":"none","borderRadius":"0","background":"#fff","borderWidth":"4px 0 0","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'年销量')" type="warning" @click="yearNumberChartDialog()">年销量</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0","boxShadow":"3px 3px 2px 0px #D0CCBA","margin":"0 0 6px","borderColor":"#D5EBC4","color":"#000","outline":"none","borderRadius":"0","background":"#fff","borderWidth":"4px 0 0","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}'	v-if="isAuth('orders'+'/'+orderStatus,'品销量')"	type="warning"	@click="goodnameNumberChartDialog()">商品销量</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0","boxShadow":"3px 3px 2px 0px #D0CCBA","margin":"0 0 6px","borderColor":"#D5EBC4","color":"#000","outline":"none","borderRadius":"0","background":"#fff","borderWidth":"4px 0 0","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'类销量')" type="warning" @click="goodtypeNumberChartDialog()">类型销量</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0","boxShadow":"3px 3px 2px 0px #D0CCBA","margin":"0 0 6px","borderColor":"#D5EBC4","color":"#000","outline":"none","borderRadius":"0","background":"#fff","borderWidth":"4px 0 0","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'日销额')" type="warning" @click="dayAmountChartDialog()">日销额</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0","boxShadow":"3px 3px 2px 0px #D0CCBA","margin":"0 0 6px","borderColor":"#D5EBC4","color":"#000","outline":"none","borderRadius":"0","background":"#fff","borderWidth":"4px 0 0","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'月销额')" type="warning" @click="monthAmountChartDialog()">月销额</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0","boxShadow":"3px 3px 2px 0px #D0CCBA","margin":"0 0 6px","borderColor":"#D5EBC4","color":"#000","outline":"none","borderRadius":"0","background":"#fff","borderWidth":"4px 0 0","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'年销额')" type="warning" @click="yearAmountChartDialog()">年销额</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0","boxShadow":"3px 3px 2px 0px #D0CCBA","margin":"0 0 6px","borderColor":"#D5EBC4","color":"#000","outline":"none","borderRadius":"0","background":"#fff","borderWidth":"4px 0 0","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'品销额')" type="warning" @click="goodnameAmountChartDialog()">商品销额</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0","boxShadow":"3px 3px 2px 0px #D0CCBA","margin":"0 0 6px","borderColor":"#D5EBC4","color":"#000","outline":"none","borderRadius":"0","background":"#fff","borderWidth":"4px 0 0","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-if="isAuth('orders'+'/'+orderStatus,'类销额')" type="warning" @click="goodtypeAmountChartDialog()">类型销额</el-button>
				</el-row>
			</el-form>
