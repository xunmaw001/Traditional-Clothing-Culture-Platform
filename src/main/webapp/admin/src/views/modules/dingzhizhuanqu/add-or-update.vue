<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="定制编号" prop="dingzhibianhao">
					<el-input v-model="ruleForm.dingzhibianhao" placeholder="定制编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.dingzhibianhao" label="定制编号" prop="dingzhibianhao">
					<el-input v-model="ruleForm.dingzhibianhao" placeholder="定制编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="定制类别" prop="dingzhileibie">
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.dingzhiyangban" label="定制样板" prop="dingzhiyangban">
					<file-upload
						tip="点击上传定制样板"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.dingzhiyangban" label="定制样板" prop="dingzhiyangban">
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="简介" prop="jianjie">
					<el-input
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else-if="ruleForm.jianjie" label="简介" prop="jianjie">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.jianjie}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="定制详情" prop="dingzhixiangqing">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else-if="ruleForm.dingzhixiangqing" label="定制详情" prop="dingzhixiangqing">
